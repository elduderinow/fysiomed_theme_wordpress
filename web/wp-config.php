...
define( 'ITSEC_ENCRYPTION_KEY', 'cjwmPSV9eExIOGtYVEEqU29CYk1rU1pQNXhjczo4cDp5N2MxMmo2ISY+P1AwWj9pZXgoMSx2IyApSDkvclcmKA==' );
...
if (!empty($_ENV['ALTERNATE_WP_CRON'])) {
	defined('ALTERNATE_WP_CRON') or define('ALTERNATE_WP_CRON', $_ENV['ALTERNATE_WP_CRON']);
}
