...
<div class="woocommerce-order checkout-order--status">
	...
	?>
		...
		<?php if ($order->has_status('failed')) : ?>
			<section class="checkout-order--failed">
		...
		<?php else : ?>
			<section class="checkout-order--received">
				<h3 class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters('woocommerce_thankyou_order_received_text', esc_html__('Thank you. Your order has been received.', 'woocommerce'), $order); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
																												?></h3>
		...
		<!-- bestelgegevens && factuur / verzendadres -->
